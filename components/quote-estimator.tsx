...
const SERVICE_RATES = {
  standard: { label: "Standard Clean", price: 119 },
  deep: { label: "Deep Clean", price: 199 },
  "move-in-move-out": { label: "Move In / Move Out", price: 279 },
}
...
const FREQUENCY_DISCOUNTS = {
  ...
  biweekly: { label: "Biweekly", discount: 0.15 },
...
const ADD_ONS = [
  ...
  { id: "baseboards", label: "Baseboards", price: 50 },
  { id: "pet-hair", label: "Pet Hair Treatment", price: 35 },
  { id: "windows", label: "Interior Windows", price: 8, perUnit: true, unitLabel: "window" },
  { id: "laundry", label: "Laundry", price: 30 },
  { id: "dishes", label: "Dishes", price: 25 },
  { id: "organization", label: "Organization", price: 50 },
]
            ...
            <div className="grid gap-5">
              ...
              <div>
                ...
                <div className="grid gap-2">
                  {Object.entries(SERVICE_RATES).map(([key, { label, price }]) => (
                    <label
                      key={key}
                    ...
                    <div key={addOn.id}>
                      ...
                      {addOn.perUnit && selectedAddOns[addOn.id] && (
                        <div className="mt-2 ml-7 flex items-center gap-2">
                          <label className="text-xs text-slate-600">Number of windows:</label>
                          <input
                            type="number"
                            min="1"
                            value={windowCount || ""}
            ...
            {calculation.customQuote ? (
              <div className="flex h-full flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Homes over 3,000 sq ft require a personalized quote. Please contact us for accurate pricing tailored to your home.
                </p>
                <a
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-slate-600">
                      {SERVICE_RATES[serviceType].label}
                    </span>
                  ...
                  {calculation.discountAmount > 0 && (
                    <div className="flex justify-between text-teal-600">
                      <span>
                        {FREQUENCY_DISCOUNTS[frequency].label} discount ({Math.round(calculation.discountRate * 100)}% off)
                      </span>
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Estimated price. Final quote may vary based on home condition and service needs.
                </p>
